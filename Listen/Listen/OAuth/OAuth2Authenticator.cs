...
namespace Listen.OAuth
{
    public class OAuth2Authenticator : WebRedirectAuthenticator
    {
        ...
        public Xamarin.Auth.OAuth2.State State
        {
            get
            {
        ...
        Xamarin.Auth.OAuth2.State request_state;
        //---------------------------------------------------------------------------------------
        #endregion  State
        ...
        {
            this.is_using_native_ui = isUsingNativeUI;
            this.State = new Xamarin.Auth.OAuth2.State();
                                                ...
                                                )
        {
            ...
            //--------------------------------------------------------------------------------------
            oauth_request_query_parameters.Add("grant_type", "authorization_code");
            //--------------------------------------------------------------------------------------
